...
app.get("/todos/", async (request, response) => {
  ...
  console.log(hasPriorityProperties(request.query));
  console.log(hasStatusProperties(request.query));
  console.log(hasCategoryProperty(request.query));
  console.log(hasCategoryAndPriorityProperties(request.query));
